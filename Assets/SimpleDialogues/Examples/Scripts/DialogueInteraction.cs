...
public class DialogueInteraction : MonoBehaviour {
    ...
    public void Display()
    {
        ...
        if (npc.hasChoices)
        {
            // Setting the text of the buttons to the choices text, in my case I know I'll 
			// always have a max of three choices for this example.
            ...
            // Setting the appropriate buttons' visibility
